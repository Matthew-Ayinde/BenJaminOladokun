...
const HeroSection = () => {
  ...
  return (
    <section id="hero" className="relative min-h-screen bg-black flex items-center overflow-hidden pt-20 lg:pt-20">
      <div className="w-full px-4 sm:px-6 lg:px-20 py-12 lg:py-20">
        <div className="max-w-[1600px] grid lg:grid-cols-2 gap-8 lg:gap-12 xl:gap-20 items-center">
          ...
          <div className="space-y-6 lg:space-y-10">
            ...
            >
              ...
              <h1 className="text-white font-light leading-[0.95] tracking-tight text-3xl sm:text-4xl lg:text-6xl xl:text-7xl">
            ...
            <motion.p
              ...
              className="text-base sm:text-lg lg:text-xl text-white/70 font-light leading-relaxed max-w-2xl"
            >
            ...
            <motion.div
              ...
              className="flex flex-col sm:flex-row gap-4 lg:gap-6 pt-2 lg:pt-3"
            >
              <button
                onClick={() => document.getElementById("about")?.scrollIntoView({ behavior: "smooth" })}
                className="group flex items-center justify-center space-x-3 bg-gradient-to-r from-emerald-600 to-emerald-500 text-white px-8 sm:px-12 lg:px-16 py-3 sm:py-4 lg:py-5 font-medium tracking-wide uppercase hover:from-emerald-500 hover:to-emerald-400 transition-all duration-300 rounded-full shadow-lg shadow-emerald-600/30 hover:shadow-xl hover:shadow-emerald-600/40"
              >
              ...
              <button
                ...
                className="group flex items-center justify-center space-x-3 border-2 border-emerald-600/50 text-white px-8 sm:px-12 lg:px-16 py-3 sm:py-4 lg:py-5 font-medium tracking-wide uppercase hover:bg-emerald-600/10 hover:border-emerald-600 transition-all duration-300 rounded-full"
              >
                <span>Speaking</span>
                <ExternalLink className="w-4 sm:w-5 h-4 sm:h-5 group-hover:scale-110 transition-transform" />
              </button>
            </motion.div>
            ...
            <motion.div
              ...
              className="flex items-center space-x-4 lg:space-x-5 pt-4 lg:pt-6"
            >
              ...
              <div className="flex space-x-3 lg:space-x-4">
                {[
                  ...
                  <a
                    key={social.label}
                    href={social.href}
                    className="w-9 sm:w-10 h-9 sm:h-10 border border-white/20 flex items-center justify-center rounded-full hover:border-emerald-600 hover:text-emerald-600 hover:bg-emerald-600/10 transition-all duration-300 group"
                  >
          ...
          <motion.div
            ...
            transition={{ duration: 0.8, delay: 0.4 }}
            className="relative flex lg:flex flex-col space-y-8 lg:hidden"
          >
            {/* Portrait Image - Mobile */}
            <div className="relative w-full aspect-[3/4] rounded-2xl sm:rounded-3xl overflow-hidden border border-emerald-600/20 shadow-2xl shadow-emerald-600/10">
              <Image
